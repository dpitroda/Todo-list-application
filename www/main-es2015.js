...
const routes = [
    ...
    {
        path: 'todos',
        loadChildren: () => __webpack_require__.e(/*! import() | todos-todos-module */ "todos-todos-module").then(__webpack_require__.bind(null, /*! ./todos/todos.module */ "./src/app/todos/todos.module.ts")).then(m => m.TodosPageModule)
    },
    {
        path: 'add-todo',
        loadChildren: () => __webpack_require__.e(/*! import() | add-todo-add-todo-module */ "add-todo-add-todo-module").then(__webpack_require__.bind(null, /*! ./add-todo/add-todo.module */ "./src/app/add-todo/add-todo.module.ts")).then(m => m.AddTodoPageModule)
    },
];
...
firebase__WEBPACK_IMPORTED_MODULE_9__["firestore"]().settings({
...
module.exports = __webpack_require__(/*! C:\Users\pitro\Desktop\final\todoapp\src\main.ts */"./src/main.ts");
